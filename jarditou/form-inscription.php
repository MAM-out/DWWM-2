...
?>
             <form action="php/config.php" method="post">
                    ...
                    <input type="text" name="login" id="logi" placeholder="Login" class="form-control" required>
                    <br></div>

                    <div class="form-group">
                    <label for="password">mot de passe* <br></label>
                    <input type="password" name="passwor" id="passwor" placeholder="mot de passe" class="form-control" required>
                    <br></div>
